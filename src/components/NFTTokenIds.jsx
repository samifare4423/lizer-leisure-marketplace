...
const { Meta } = Card;
//STEP 1: this section decides on the style of your shop
const styles = {
  NFTs: {
    display: "flex",
    flexWrap: "wrap",
  ...
  //Step 2: Here is where you can change the look and feeling of your text
  text: {
    color: "#041836",
    fontSize: "27px",
    fontWeight: "bold",
          ...
          <>
            ...
            <div style={styles.banner}>
              ...
              <div style={styles.text}>
                <>
                  <div style={{  color: "white",}} >{`${NFTTokenIds[0]?.name}`}</div>
                  <div
                    style={{
                      fontSize: "15px",
                      color: "white",
          ...
          {inputValue === "explore" &&
            NFTCollections?.map((nft, index) => (
              <Card
                ...
                style={{ width: 240, border: "2px solid #e7eaf3", borderRadius:"10px", margin:"20px", }}
                cover={
                  <Image
                    preview={false}
                    src={nft?.image || "error"}
                    fallback={fallbackImg}
                    alt=""
                    style={{ maxHeight: "300px", width:"100%", borderRadius:"10px", }}
                  />
                }
                key={index}
              >
          ...
          {inputValue !== "explore" &&
            NFTTokenIds.slice(0, 20).map((nft, index) => (
              <Card
                ...
                style={{ width: 240, height:"auto", border: "2px solid #e7eaf3" , borderRadius:"10px", margin:"20px",}}
                cover={
                  <Image
                    preview={false}
                    src={nft.image || "error"}
